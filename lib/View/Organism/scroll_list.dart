  ...
  Widget _buildHorizontalItem(BuildContext context, int verticalIndex) {
    ...
    return SizedBox(
      ...
      child: PageView.builder(
        //今はPageView.blulder→moleculeでボタン5つ並べる
        controller: PageController(viewportFraction: 0.3),
        //pagecontrollerサイズ指定？デフォルトは0.8
        itemCount: 5,
        //3
            ...
            child: Card(
              child: ElevatedButton(
                child: SizedBox(
                  ...
                  //height: 140,//240
                  child: Image.asset(
                      'assets/images/image$verticalIndex-$horizontalIndex.jpg'),
                ...
                onPressed: () {
                  ...
                  if (audioController.isPlay(/*horizontalIndex+verticalIndex*5*/
                      ai)) {
                    audioController
                        .pauseAudio(/*horizontalIndex+verticalIndex*5*/ ai);
                  } else {
                    audioController.playAudio(
                        /*verticalIndex-horizontalIndex+verticalIndex*5*/
                        ai);
                  }
                },
              ),
